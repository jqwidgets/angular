...
export class AppComponent implements AfterViewInit {
    ...
    renderAppointment = (data) => {
        ...
        if (data.appointment.subject == 'Nancy') {
            img = '<img style="top: 2px; position: relative;" src="https://www.jqwidgets.com/angular/images/woman.png"/>';
        }
        else if (data.appointment.subject == 'Peter') {
            img = '<img style="top: 2px; position: relative;" src="https://www.jqwidgets.com/angular/images/boss.png"/>';
        }
        else if (data.appointment.subject == 'Antony') {
            img = '<img style="top: 2px; position: relative;" src="https://www.jqwidgets.com/angular/images/oldboss.png"/>';
        }
        else if (data.appointment.subject == 'John') {
            img = '<img style="top: 2px; position: relative;" src="https://www.jqwidgets.com/angular/images/asian.png"/>';
        }
