...
export class AppComponent implements AfterViewInit {
    ...
    generateAppointments() {
        ...
        let appointment3 = {
            ...
            end: new Date(2025, 10, 26, 13, 0, 0)
        }
        let appointment4 = {
            id: 'id4',
            description: '',
            ...
            end: new Date(2025, 10, 27, 18, 0, 0)
        }
        let appointment5 = {
            id: 'id5',
            description: '',
            ...
            calendar: 'Room 1',
            start: new Date(2025, 10, 24, 15, 0, 0),
        ...
        let appointment6 = {
            ...
            calendar: 'Room 4',
            start: new Date(2025, 10, 24, 14, 0, 0),
            end: new Date(2025, 10, 30, 16, 0, 0)
        }
