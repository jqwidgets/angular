...
export class AppComponent implements AfterViewInit {
    ...
    generateAppointments() {
        ...
        let appointment1 = {
            ...
            calendar: 'Room 1',
            start: new Date(2025, 10, 23, 9, 15, 0),
        ...
        let appointment2 = {
            ...
            calendar: 'Room 2',
            start: new Date(2025, 10, 24, 10, 45, 0),
        ...
        let appointment3 = {
            ...
            calendar: 'Room 3',
            start: new Date(2025, 10, 27, 11, 30, 0),
        ...
        let appointment4 = {
            ...
            calendar: 'Room 2',
            start: new Date(2025, 10, 23, 16, 15, 0),
            end: new Date(2025, 10, 26, 18, 0, 0)
        }
        let appointment5 = {
            id: 'id5',
            description: '',
            ...
            calendar: 'Room 1',
            start: new Date(2025, 10, 25, 15, 45, 0),
        ...
        let appointment6 = {
            ...
            calendar: 'Room 4',
            start: new Date(2025, 10, 26, 14, 30, 0),
