...
export class AppComponent {
        ...
        [
            {
                ...
                cellsrenderer: (row: number, column: any, value: any): string => {
                    return '<img src="https://www.jqwidgets.com/angular/images/t-shirts/' + value + '"/>';
                }
            },
    ...
    scrollfeedback = (row: any): string => {
        return '<table style="height: 150px;"><tr><td><img src="https://www.jqwidgets.com/angular/images/t-shirts/' + row.pic + '"/></td></tr><tr><td>' + row.label + '</td></tr></table>';
    };
}