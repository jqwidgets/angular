...
export class AppComponent {
	...
	columns: any[] =
		[
			...
			{
				text: 'Pie', dataField: 'points', columntype: 'sparklines', sparklines: {
					type: 'pie',
					max: 100,
					colorFunction(value) {
			...
			{
				text: 'Column', dataField: 'columnPoints', columntype: 'sparklines', sparklines: {
					type: 'column',
					max: 100,
					colorFunction(value) {
						const colors = ['#D50000', '#F4511E', '#F6BF26', '#33B679'];
			...
			{
				text: 'Bar', dataField: 'barPoints', columntype: 'sparklines', sparklines: {
					type: 'bar',
					max: 100,
					colorFunction(value) {
						const colors = ['#D50000', '#F4511E', '#F6BF26', '#33B679'];
			...
			{
				text: 'Line', dataField: 'linePoints', columntype: 'sparklines', sparklines: {
					type: 'line',
					max: 100,
					colorFunction(value) {
						const colors = ['#D50000', '#F4511E', '#F6BF26', '#33B679'];
