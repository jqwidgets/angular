...
export class AppComponent {
    ...
    initiMainGrid: any = () => {
        ...
        let mainGrid: jqwidgets.jqxRibbon = jqwidgets.createInstance('#mainGrid', 'jqxRibbon', {
            theme: 'material',
            width: '100%',
            autoheight: true,
    ...
    initiSocialGrid = () => {
        ...
        let socialGrid: jqwidgets.jqxRibbon = jqwidgets.createInstance('#socialGrid', 'jqxRibbon', {
            theme: 'material',
            width: '100%',
            autoheight: true,
