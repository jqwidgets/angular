import { Component, ViewChild, AfterViewInit } from '@angular/core';  import { jqxDataTableComponent } from 'jqwidgets-scripts/jqwidgets-ts/angular_jqxdatatable.ts';  @Component({     selector: 'app-root',     templateUrl: './app.component.html'
 })  export class AppComponent implements AfterViewInit {     @ViewChild('myDataTable') myDataTable: jqxDataTableComponent;      ngAfterViewInit(): void {         this.myDataTable.showDetails(0);
    ...
    initRowDetails = (id: any, row: any, element: any, rowinfo: any): void => {
        ...
        if (tabsdiv !== null) {
            ...
            img.src = 'https://www.jqwidgets.com/angular/images/' + row.firstname.toLowerCase() + '.png';
