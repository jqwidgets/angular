...
export class  omponent implements AfterViewInit {    
    @ViewChild('myDataTable') myDataTable: jqxDataTableComponent;    
    ngAfterViewInit(): void {        this.myDataTable.showDetails(0);
    }
    
    source: any =    {  
		localData: this.generateData(),
                 dataType: 'aray'    };    dataAdapter: any = new jqx.dataAdapter(this.source);   
                 
                 columns: any[] =    [        { text: 'First Name', dataField: 'firstname', width: 200 },
                 { text: 'Last Name', dataField: 'lastname', width: 200 },
    Title', dataField: 'tie', width: 200 },
